...
try {
  ...
  setMessage("SMS sent! (check your terminal for the code)");
  setStep("code");
} catch (err) {
...
Simple SMS verification demo.
    ...
    {step === "success" && (
      <div className="space-y-3 text-center">
        <p className="text-lg font-medium">✅ Logged in</p>
        <p className="text-sm text-neutral-300">
          You now have a working SMS login flow!
        </p>
      </div>
    )}
  </div>
